...
<html>
<head>
    <title>Payment Virtual Account BCA The Executive</title>
...
<body>
    ...
    <table id="example" class="display" cellspacing="0" width="100%">
        ...
        WHERE (a.parent_item_id is null) and sog.payment_method='prismalink_vabca' and sog.status ='processing' and
...
// LEFT JOIN sales_order_address soa ON sog.entity_id=soa.parent_id
// LEFT JOIN sales_order so ON a.order_id=so.entity_id
// WHERE (a.parent_item_id is not null) and sog.payment_method='prismalink_vabca' and sog.status ='processing' and 
// sog.created_at BETWEEN NOW() - INTERVAL 8 DAY AND NOW()
        $query = $db->query($sql);
        $noUrut=1;
