...
<body>
	...
	<table id="example" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
        <?php
        $sql = "select d.id_order_detail, o.id_order, o.delivery_date, o.total_discounts, o.id_customer, c.firstname, c.lastname, o.total_paid, d.product_name, d.product_quantity_discount, d.product_reference
               FROM ps_orders o LEFT JOIN ps_order_detail d
               ON o.id_order = d.id_order 
               INNER JOIN ps_customer c 
               ON o.id_customer = c.id_customer
               WHERE o.module = 'cashondelivery' AND o.date_add BETWEEN NOW() - INTERVAL 5 DAY AND NOW()
