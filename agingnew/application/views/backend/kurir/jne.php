    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-primary card-header-icon">
          ...
          <h4 class="card-title">Airwaybill JNE <br>
            (<a href="<?php echo base_url('backend/exceljne'); ?>" style="color:#8e24aa;"><small>Download Excel</small></a>)
          </h4>
        </div>
        <div class="card-body">
          <div class="toolbar">
          ...
          <div class="material-datatables">
            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
              <thead>
                <tr>
                  <th>Receiver Name</th>
                  <th style="width: 500px">Receiver Address</th>
                  <th>Receiver City</th>
                  <th>Qty</th>
                  <th>Goods Value</th>
                  <th>Service</th>
