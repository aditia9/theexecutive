...
class City extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    const BLOCK_ID = 'city_upload_button';
    ...
    {
        return $this->getUrl('hypeworkshipping/city/import'); //hit controller by ajax call on button click.
    }
     /**
    ...
    {
        return $this->_scopeConfig->getValue('hypework_shipping/city/browse');
    }
