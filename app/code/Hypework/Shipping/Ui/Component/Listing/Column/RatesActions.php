...
use \Hypework\Shipping\Model\ResourceModel\Rates as ratesResourceModel;

class RatesActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
     * Url path  to edit
     *
     * @var string
     */
    const FAQ_CATEGORY_URL_PATH_EDIT = 'hypeworkshipping/rates/edit';
    /**
     * Url path to delete
     *
     * @var string
     */
    const FAQ_CATEGORY_URL_PATH_DELETE = 'hypeworkshipping/rates/delete';
    /**
     * URL builder
     *
                ...
                if (isset($item['entity_id'])) {
                    ...
                    $item[$name]['delete'] = [
                        ...
                        'confirm' => [
                            ...
                            'message' => __('Are you sure you wan\'t to delete this Rates?')
                        ]
                    ];
                }
