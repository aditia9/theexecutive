...
namespace Hypework\ShippingLion\Model\Carrier;
 
use Magento\Quote\Model\Quote\Address\RateRequest;
use Magento\Shipping\Model\Rate\Result;
 
class Lion extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    /**
     * @var string
     */
    protected $_code = 'lion';
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        $carrierTitle = $configShipping->getValue('carriers/lion/title', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $carrierName = $configShipping->getValue('carriers/lion/name', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        ...
        foreach ($rate as $key => $value) {
            ...
            // if (!empty($value->min_free_shipping_amount) && $grandTotal > $value->min_free_shipping_amount) {
