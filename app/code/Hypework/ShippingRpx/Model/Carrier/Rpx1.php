 ...
 * Time: 8:35 PM
 */
namespace Hypework\ShippingRpx\Model\Carrier;
 
use Magento\Quote\Model\Quote\Address\RateRequest;
use Magento\Shipping\Model\Rate\Result;
 
class Rpx extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    protected $_freeShippingMinCartAmount = 100000;
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        $carrierTitle = $configShipping->getValue('carriers/rpx/title', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $carrierName = $configShipping->getValue('carriers/rpx/name', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
