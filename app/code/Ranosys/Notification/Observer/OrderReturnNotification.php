...
class OrderReturnNotification implements ObserverInterface {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        ...
        $message = __('Your return request for order #%1 has been submitted successfully.', $order->getIncrementId());
        ...
        foreach($customerDevices as $customerDevice) {
            try {
                ...
                $this->logger->critical('===== Order Return Request Notification Debugging Start =======');
                ...
                $this->logger->critical('===== Order Return Request Notification Debugging  End =======');
            }
        }
    }
